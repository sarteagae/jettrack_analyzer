void plotQAandDijetHistograms() {
  ...
  //  const char* file3 = "histos_Data_wZDC_pPb_gamma_proton_wtFRGcuts_OCt28_pPb_Data_8160GeV_Quench_ak4PFJetAnalyzer_nojettrig_Jptmin_10p0_Jptmax_8160p0_Jetamin_N1p0_Jetamax_1p0_TOTAL.root";
   ...
   const char* file1 ="histos_MC_gam_proton_FRGles2p0_BRGles2p0_FRGaftjets_jetsAftBRG_March24_total.root"; //gam_protn MC
   const char* file2 = "histos_MC_gam_pom_FRGles2p0_BRGles2p0_FRGaftjets_jetsAftBRG_March24_total.root";    //gam_pom MC
    const char* file3 = "histos_DATA_FRGles2p0_BRGles2p0_FRGaftjets_jetsAftBRG_March24_job_PD1to13.root";
    const char* file4 ="histos_QCD_FRGles2p0_BRGles2p0_FRGaftjets_jetsAftBRG_March24_total.root";
...
pPbText.DrawLatex(0.75, 0.92, "pPb 8.16TeV (2016)");  // Position pPb label
    ...
    c1->SaveAs("QA_Histogram_FRG_sum_March24.pdf");
    delete c1;
