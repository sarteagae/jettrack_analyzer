void plotTH1hist() {
   ...
   // const char* file3 = "histos_Data_wZDC_pPb_gamma_proton_wtFRGcuts_OCt28_pPb_Data_8160GeV_Quench_ak4PFJetAnalyzer_nojettrig_Jptmin_10p0_Jptmax_8160p0_Jetamin_N1p0_Jetamax_1p0_TOTAL.root";
     ...
     const char* file1 =
    "histos_MC_gam_proton_FRGles3_FRGaftjets_jetsAftFRGFeb28_Jptmin20_Jetamin2p5_TOTAL.root";
   const char* file2 = ".root";
    ...
    const char* qa_hist_name = "hist_BRG_bf_hfcuts";
    ...
    TH1F *qa_hist1 = dynamic_cast<TH1F*>(qa_dir1->Get(qa_hist_name));
    TH1F *qa_hist2 = dynamic_cast<TH1F*>(qa_dir2->Get(qa_hist_name));
    TH1F *qa_hist3 = dynamic_cast<TH1F*>(qa_dir3->Get(qa_hist_name));
    TH1F *qa_hist4 = dynamic_cast<TH1F*>(qa_dir4->Get(qa_hist_name));
    ...
    gPad->SetLogy();
    gPad->SetLogx();
    qa_hist1->Scale(3.9189); //5.28 da un mejor agreement pero el "real es 3.9189" gam-pom calculado con base en el nuevo #events del nuevo MC
    qa_hist2->Scale(0.1972);  // factor from xsec from pythia gam-proton
    qa_hist3->Scale(1.0); 
    qa_hist4->Scale(915.72); //2818.05 QCD embeded; 915.72 QCD no embeded
   ...
   // qa_hist1->SetMaximum(qa_hist3->GetMaximum());
    ...
    legend->AddEntry(qa_hist1, "PYTHIA8 SD", "l");
    legend->AddEntry(qa_hist2, "PYTHIA8 photo-ND", "l");
    //legend->AddEntry(qa_hist4, "PYTHIA8 ND no-embedded", "l");
