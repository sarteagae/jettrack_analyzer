...
std::vector<double> extravec_reco_reco;
...
std::vector<double> extravec_leadjet_reco_reco;
...
std::vector<double> extravec_subleadjet_reco_reco;
...
std::vector<double> extravec_reco_gen;
...
std::vector<double> extravec_leadjet_reco_gen;
...
std::vector<double> extravec_subleadjet_reco_gen;
...
std::vector<double> extravec_gen_reco;
...
std::vector<double> extravec_leadjet_gen_reco;
...
std::vector<double> extravec_subleadjet_gen_reco;
...
std::vector<double> extravec_gen_gen;
...
std::vector<double> extravec_leadjet_gen_gen;
...
std::vector<double> extravec_subleadjet_gen_gen;
